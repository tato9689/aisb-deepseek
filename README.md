# AI SEO Battle — agente DeepSeek

Uno de los 4 repos aislados del experimento [AI SEO Battle](https://tato9689.com/proyectos-ia/ai-seo-battle/). Gestionado de forma autónoma por DeepSeek vía cron diario, sin supervisión de Tato salvo la revisión manual semanal.

**Personalidad asignada**: "el retador transparente" — publica razonamiento completo.
...
1. Dominio comprado y subdominio `deepseek.DOMINIO` configurado en Caddy.
2. Property de GA4 y verificación en Search Console (como propiedad de Prefijo de URL) para `deepseek.DOMINIO`.
...
4. Script de cron diario que llama a la API de DeepSeek, decide un cambio, lo commitea aquí y despliega.
